        ...
        <>
            ...
            <div className="min-h-screen flex items-stretch">
                <div class="flex justify-center h-screen">
                    <div class="hidden bg-cover lg:block lg:w-2/3" style={{backgroundImage: `url(${register})`,width: '1550px',}}>
                    ...
                    <div class="lg:w-1/2 w-full flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">


                        <div class="flex-1">
                            <div class="text-center">
                                <h2 class="text-4xl font-bold text-center text-gray-700 dark:text-white">What's New?</h2>
